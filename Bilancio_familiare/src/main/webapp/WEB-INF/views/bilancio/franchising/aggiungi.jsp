...
<head>
<meta charset="UTF-8">
<title>Aggiungi un franchising</title>
<script
...
<body>
	...
	<div class="container">
		<hr />
		<div class="row title">
		Aggiungi franchising</div>
		<hr />
		
		<form:form action="aggiungi" modelAttribute="newfranchising" method="POST">
			...
			<div class="form-group">
				<label class="etichetta" for="nome">GRUPPO : </label>
				<form:input path="gruppo" type="text" class="form-control" id="gruppo"
					placeholder="Enter gruppo" />
				<form:errors path="gruppo" cssClass="error" />	
			</div>
			<hr />
