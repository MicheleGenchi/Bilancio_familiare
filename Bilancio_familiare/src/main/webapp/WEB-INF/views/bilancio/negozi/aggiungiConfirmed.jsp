...
<html>
<head>
<title>Negozio aggiunto con successo</title>
...
<body>
	...
	<div class="container">
		<div class="row title">Negozio</div>
		...
		<ul class="list-group list-group-flush">
			...
			<li class="list-group-item"><ul>ID : ${param.id}
				...
				<ul>INDIRIZZO : ${param.indirizzo}
				</ul>
			</li>
			<li class="list-group-item"><ul>ID : ${param.id}
				</ul>
				<ul>TIPOLOGIA : ${tipologia}			FRANCHISING: ${franchising}
				</ul>
			</li>
			
		</ul>
		<br/>
		<div class="${messaggio.tipo}" role="alert">${messaggio.messaggio}
		</div>
		<br/>
		<ul>
			<a href="http://localhost:8080/bilancio/negozi/aggiungi"
